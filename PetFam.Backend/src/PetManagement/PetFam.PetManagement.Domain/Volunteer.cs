...
namespace PetFam.PetManagement.Domain
{
    public class Volunteer : Entity<VolunteerId>, ISoftDeletable
    {
        ...
        public Result ChangePetOrder(Pet pet, int newOrderNumber)
        {
        ...
        public Result SetPetFirstInOrder(Pet pet)
        {
            return ChangePetOrder(pet, 0);
        }

        public Result SetPetLastInOrder(Pet pet)
        {
